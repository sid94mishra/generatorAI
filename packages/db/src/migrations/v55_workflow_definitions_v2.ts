...
export const V55_LOCK_FILES = [
  ...
  'v55/convert.ts',
  'v55/spec/commandBearing.ts',
  'v55/spec/constants.ts',
  'v55/spec/expr/ast.ts',
  'v55/spec/expr/evaluate.ts',
  'v55/spec/expr/filters.ts',
  'v55/spec/expr/functions.ts',
  'v55/spec/expr/grammar.ts',
  'v55/spec/expr/index.ts',
  'v55/spec/expr/parse.ts',
  'v55/spec/expr/template.ts',
  'v55/spec/expr/typecheck.ts',
  'v55/spec/expr/types.ts',
  'v55/spec/expr/values.ts',
  'v55/spec/regex/safeRegex.ts',
  'v55/spec/schemas/common.ts',
  'v55/spec/schemas/edge.ts',
  'v55/spec/schemas/errors.ts',
  'v55/spec/schemas/graph.ts',
  'v55/spec/schemas/session.ts',
  'v55/spec/schemas/stage.ts',
  'v55/spec/schemas/workflow.ts',
  'v55/spec/state/index.ts',
  'v55/spec/state/stageRun.ts',
  'v55/spec/state/workflowRun.ts',
  'v55/spec/util/text.ts',
  'v55/spec/util/zodWalk.ts',
  'v55/spec/validate/capability.ts',
  'v55/spec/validate/dag.ts',
  'v55/spec/validate/hints.ts',
  'v55/spec/validate/index.ts',
  'v55/spec/validate/issues.ts',
  'v55/spec/validate/scope.ts',
  'v55/spec/validate/security.ts',
  'v55/spec/validate/validateWorkflow.ts',
] as const;
