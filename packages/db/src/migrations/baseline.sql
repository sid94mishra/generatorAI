...
-- Fresh-DB baseline: the schema every migration up to v56 (session_parity)
-- produces. migrateDB applies it to an EMPTY database and stamps v1..v56;
...
CREATE TABLE chat_messages (
      ...
      tool_result TEXT,
      timestamp INTEGER NOT NULL
    , metadata TEXT, chat_id TEXT, agent_ref TEXT, agent_version INTEGER, complete INTEGER NOT NULL DEFAULT 1);
