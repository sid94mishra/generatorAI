-- Schema-only snapshot of a real developer database at v52
...
CREATE TABLE chats (
      ...
      created_at    INTEGER NOT NULL,
      updated_at    INTEGER NOT NULL
    , git_repositories TEXT, project_id TEXT, selected_artifacts TEXT DEFAULT '{}', workspace_id TEXT, use_worktree INTEGER NOT NULL DEFAULT 1, codebase_ids TEXT, harness_config TEXT, orchestrator_mode INTEGER NOT NULL DEFAULT 0, parent_chat_id TEXT, background_task_name TEXT, background_task_index INTEGER, background_task_status TEXT, default_agent_mode TEXT NOT NULL DEFAULT 'interactive', permission_mode TEXT NOT NULL DEFAULT 'bypassPermissions', agent_ref TEXT, agent_id TEXT, agent_version INTEGER, agent_overrides TEXT, agent_snapshot TEXT, orchestrator_wave_count INTEGER, orchestrator_started_at INTEGER, sources TEXT, primary_source TEXT);
...
CREATE TABLE stage_definitions (
      ...
      condition                TEXT,
      created_at               INTEGER NOT NULL
    , selected_artifacts TEXT DEFAULT '{}', context_filter TEXT DEFAULT 'summary-only', agent_name TEXT, result_validation TEXT, expected_output TEXT, output_schema TEXT, iteration_config TEXT, context_sources TEXT, output_format TEXT DEFAULT 'text', harness_config_overrides TEXT, approval_required INTEGER NOT NULL DEFAULT 0, agent_mode TEXT, agent_ref TEXT);
...
CREATE TABLE stage_runs (
      ...
      started_at               INTEGER,
      completed_at             INTEGER
    , summary TEXT, version INTEGER NOT NULL DEFAULT 0, wake_at INTEGER, slept_since INTEGER, interrupt_data TEXT, output_data TEXT, artifact_manifest TEXT, iteration_index INTEGER DEFAULT 0, parent_stage_run_id TEXT, output_text TEXT, heartbeat_at INTEGER, lease_owner TEXT);
...
CREATE TABLE conversation_instance_ownership (
          ...
          updated_at      INTEGER NOT NULL
        , provider TEXT, adapter_key TEXT, resume_cursor TEXT, runtime_payload TEXT, runtime_mode TEXT, binding_origin TEXT NOT NULL DEFAULT 'explicit');
...
CREATE INDEX idx_idempotency_keys_scope_expires ON idempotency_keys(scope, expires_at);
...
INSERT INTO _schema_versions (version, applied_at, name) VALUES (12, 0, 'composite_indexes_stage_runs_and_chat_messages');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (13, 0, 'integrated_browser_artifact_types');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (14, 0, 'widgets_and_extensions');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (15, 0, 'automation_retry_schema_and_idempotency');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (16, 0, 'widget_surface_inline_or_widget');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (17, 0, 'orchestrator_mode_background_tasks');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (18, 0, 'workspace_checkpoints');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (19, 0, 'review_threads_and_comments');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (20, 0, 'checkpoint_phase');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (21, 0, 'plan_mode');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (22, 0, 'agent_mode_rename');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (23, 0, 'plan_status_recorded');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (24, 0, 'security_device_auth_relay');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (25, 0, 'device_push_registry');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (26, 0, 'first_class_agents');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (27, 0, 'computer_use');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (28, 0, 'computer_use_grant_scope');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (29, 0, 'sequence_seed_once');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (30, 0, 'unify_event_sequence_space');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (31, 0, 'missing_chat_indexes');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (32, 0, 'stream_meta');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (33, 0, 'conversation_ownership');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (34, 0, 'system_configs_add_mcp_type');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (35, 0, 'workflow_runs_ancestor_run_id');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (36, 0, 'w47_registers');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (37, 0, 'w47_entries');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (38, 0, 'w47_usage_ledger');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (39, 0, 'workflow_definitions_skills_agents');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (40, 0, 'conversation_instance_ownership');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (41, 0, 'chats_orchestrator_wave_state');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (42, 0, 'entries_unique_tool_result_key');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (43, 0, 'drop_dead_usage_ledger');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (44, 0, 'provider_runtime_binding_columns');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (45, 0, 'execution_workspaces_code_root');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (46, 0, 'stage_run_heartbeat_and_run_definition_snapshot');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (47, 0, 'automations_scheduler_and_webhook_hash');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (48, 0, 'project_configs_credential_refs');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (49, 0, 'stream_cursors_kind_ts_index');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (50, 0, 'drop_usage_ledger');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (51, 0, 'workspace_mounts');

INSERT INTO _schema_versions (version, applied_at, name) VALUES (52, 0, 'device_scope_requests');
