// ────────────────────────────────────────────────────────────────
// dropdown-menu — vendored shadcn/ui part (Radix DropdownMenu)
// Use for overflow ("…") menus, row actions, and split buttons.
// ────────────────────────────────────────────────────────────────
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-[1100] min-w-[8rem] rounded-lg border border-border bg-popover p-1 text-popover-foreground shadow-lg',
  ...
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      danger
        ...
        : 'text-foreground focus:bg-subtle',
