// ────────────────────────────────────────────────────────────────
// command — vendored shadcn/ui part (cmdk)
// Powers the ⌘K command palette and SearchableSelect listboxes.
// ────────────────────────────────────────────────────────────────
...
function CommandDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent hideClose className="w-[min(92vw,40rem)] p-0" aria-describedby={undefined}>
        <Command
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center gap-2.5 border-b border-border px-4" cmdk-input-wrapper="">
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        'flex h-11 w-full bg-transparent text-sm text-foreground outline-none placeholder:text-muted-foreground',
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ...
    className={cn(
      ...
      'data-[selected=true]:bg-subtle data-[selected=true]:text-foreground',
