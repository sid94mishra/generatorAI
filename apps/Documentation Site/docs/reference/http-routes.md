...
| `POST` | `/api/workflow-scripts/:id/run` | 189 |
| `POST` | `/api/workflow-scripts/reload` | 342 |
| `POST` | `/api/workflow-scripts/:id/reload` | 354 |
| `POST` | `/api/workflow-scripts/upload` | 381 |
| `POST` | `/api/workflow-scripts/validate` | 430 |
