...
| `POST` | `/api/workflow-scripts/:id/run` | 190 |
| `POST` | `/api/workflow-scripts/reload` | 344 |
| `POST` | `/api/workflow-scripts/:id/reload` | 356 |
| `POST` | `/api/workflow-scripts/upload` | 383 |
| `POST` | `/api/workflow-scripts/validate` | 432 |
