# Hooks, variables, prompts and result rules: configuration fields

Generated from `packages/workflow-spec/src/schemas/common.ts` by `npm run configuration:generate`. These are the actual evaluated Zod contracts, including composed/partial schemas, defaults, nested objects, unions, and numeric/string limits.
...
| Field | Type / choices | Input / default | Constraints |
| --- | --- | --- | --- |
| (value) | string | `required` | min 1; max 2000 |

## TemplateSchema

| Field | Type / choices | Input / default | Constraints |
| --- | --- | --- | --- |
| (value) | string | `required` | max 100000 |
...
| Field | Type / choices | Input / default | Constraints |
| --- | --- | --- | --- |
| (value) | string | `required` | regex /^secretref:[A-Za-z0-9_.:/-]{1,200}$/ |

## PositionSchema

| Field | Type / choices | Input / default | Constraints |
| --- | --- | --- | --- |
| x | number | `required` | finite |
| y | number | `required` | finite |
...
| options | array of string | `optional` | maxLength 100 |

## HookConfigSchema

| Field | Type / choices | Input / default | Constraints |
| --- | --- | --- | --- |
| (value) | variants by type (object / object / object) | `required` | refinement |
| &lt;variant 1&gt; | object | `required` | unknown keys: strict |
| &lt;variant 1&gt;.type | "script" | `required` | — |
| &lt;variant 1&gt;.command | string | `required` | min 1; max 1000 |
| &lt;variant 1&gt;.args | array of string | `optional` | maxLength 64 |
| &lt;variant 1&gt;.cwd | string | `optional` | max 1000 |
| &lt;variant 1&gt;.env | map of string | `optional` | — |
| &lt;variant 2&gt; | object | `required` | unknown keys: strict |
| &lt;variant 2&gt;.type | "http" | `required` | — |
| &lt;variant 2&gt;.url | string | `required` | url; max 2000 |
| &lt;variant 2&gt;.method | "GET" / "POST" / "PUT" / "PATCH" / "DELETE" | `required` | — |
| &lt;variant 2&gt;.headers | map of string | `optional` | — |
| &lt;variant 2&gt;.bodyTemplate | string | `optional` | max 100000 |
| &lt;variant 3&gt; | object | `required` | unknown keys: strict |
| &lt;variant 3&gt;.type | "function" | `required` | — |
| &lt;variant 3&gt;.modulePath | string | `optional` | max 1000 |
| &lt;variant 3&gt;.handlerName | string | `optional` | max 200 |
| &lt;variant 3&gt;.args | map of unknown | `optional` | — |
...
| priority | number | `default 0` | int; min -1000; max 1000 |
| enabled | boolean | `default true` | — |
| failurePolicy | "abort" / "skip" / "continue" | `default "skip"` | — |
| timeoutMs | number | `default 30000` | int; min 100; max 600000 |
| retries | number | `default 0` | int; min 0; max 5 |
| config | variants by type (object / object / object) | `required` | refinement |
| config&lt;variant 1&gt; | object | `required` | unknown keys: strict |
| config&lt;variant 1&gt;.type | "script" | `required` | — |
| config&lt;variant 1&gt;.command | string | `required` | min 1; max 1000 |
| config&lt;variant 1&gt;.args | array of string | `optional` | maxLength 64 |
| config&lt;variant 1&gt;.cwd | string | `optional` | max 1000 |
| config&lt;variant 1&gt;.env | map of string | `optional` | — |
| config&lt;variant 2&gt; | object | `required` | unknown keys: strict |
| config&lt;variant 2&gt;.type | "http" | `required` | — |
| config&lt;variant 2&gt;.url | string | `required` | url; max 2000 |
| config&lt;variant 2&gt;.method | "GET" / "POST" / "PUT" / "PATCH" / "DELETE" | `required` | — |
| config&lt;variant 2&gt;.headers | map of string | `optional` | — |
| config&lt;variant 2&gt;.bodyTemplate | string | `optional` | max 100000 |
| config&lt;variant 3&gt; | object | `required` | unknown keys: strict |
| config&lt;variant 3&gt;.type | "function" | `required` | — |
| config&lt;variant 3&gt;.modulePath | string | `optional` | max 1000 |
| config&lt;variant 3&gt;.handlerName | string | `optional` | max 200 |
| config&lt;variant 3&gt;.args | map of unknown | `optional` | — |
| phase | "pre_run" / "post_run" / "pre_prompt" / "post_prompt" / "on_error" / "on_cancel" / "pre_tool_use" / "post_tool_use" / "on_message" / "on_reasoning" / "on_session_start" / "on_session_idle" / "on_session_error" / "on_session_cancelled" | `required` | — |
...
| --- | --- | --- | --- |
| name | string | `required` | min 1; max 200 |
| config | union (variants by type (object / object / object) / object) | `required` | — |
| config&lt;variant 2&gt; | object | `required` | unknown keys: strict |
| config&lt;variant 2&gt;.type | "restore_checkpoint" | `required` | — |
| timeoutMs | number | `default 30000` | int; min 100; max 600000 |
| retries | number | `default 3` | int; min 0; max 5 |
...
| &lt;variant 1&gt;.message | string | `optional` | max 1000 |
| &lt;variant 2&gt; | object | `required` | unknown keys: strict |
| &lt;variant 2&gt;.type | "not_contains" | `required` | — |
| &lt;variant 2&gt;.value | string | `required` | min 1; max 10000 |
| &lt;variant 2&gt;.message | string | `optional` | max 1000 |
| &lt;variant 3&gt; | object | `required` | unknown keys: strict |
| &lt;variant 3&gt;.type | "min_length" | `required` | — |
| &lt;variant 3&gt;.value | number | `required` | int; min 0; max 10000000 |
| &lt;variant 3&gt;.message | string | `optional` | max 1000 |
| &lt;variant 4&gt; | object | `required` | unknown keys: strict |
| &lt;variant 4&gt;.type | "max_length" | `required` | — |
| &lt;variant 4&gt;.value | number | `required` | int; min 0; max 10000000 |
| &lt;variant 4&gt;.message | string | `optional` | max 1000 |
| &lt;variant 5&gt; | object | `required` | unknown keys: strict |
| &lt;variant 5&gt;.type | "regex" | `required` | — |
| &lt;variant 5&gt;.pattern | string | `required` | min 1; max 1000 |
| &lt;variant 5&gt;.flags | string | `optional` | regex /^[ims]{0,3}$/ |
| &lt;variant 5&gt;.message | string | `optional` | max 1000 |
| &lt;variant 6&gt; | object | `required` | unknown keys: strict |
| &lt;variant 6&gt;.type | "custom_script" | `required` | — |
| &lt;variant 6&gt;.command | string | `required` | min 1; max 1000 |
| &lt;variant 6&gt;.args | array of string | `default []` | maxLength 64 |
| &lt;variant 6&gt;.env | map of string | `optional` | — |
| &lt;variant 6&gt;.timeoutMs | number | `default 60000` | int; min 1000; max 600000 |
| &lt;variant 6&gt;.message | string | `optional` | max 1000 |
| &lt;variant 7&gt; | object | `required` | unknown keys: strict |
...
<details>
<summary>Read the complete common.ts source contract</summary>
