...
[Workflows](../configuration/workflows.md), [Templates](../configuration/templates.md), [Examples](../configuration/examples.md), [Control flow: loops, maps, waits and sub-workflows](./workflow-control-flow.md), [Workflows from agents](./workflows-from-agents.md). See the [feature recipes](../guide/feature-recipes.md) for steps and observable results.
